                ...
                <div class="compartment">
                    ...
                    <div class="silk-harmonica silk-harmonica--expanded silk-harmonica--solutions">
                        <header role="tab" class="silk-harmonica__header">
                            ...
                            <figure><img src="<?php bloginfo('template_url'); ?>/assets/images/drilling.jpg" alt="undefined">
                            </figure>
                        </header>
                        ...
                        <header role="tab" class="silk-harmonica__header">
                            ...
                            <figure><img src="<?php bloginfo('template_url'); ?>/assets/images/room.jpg" alt="undefined">
                            </figure>
                        </header>
                        <article role="tabpanel" class="silk-harmonica__content">
                            <h2>Our Solution</h2>
                        ...
                        <header role="tab" class="silk-harmonica__header">
                            ...
                            <figure><img src="<?php bloginfo('template_url'); ?>/assets/images/hands.jpg" alt="undefined">
                            </figure>
                        </header>
                        <article role="tabpanel" class="silk-harmonica__content">
                            <h2>Our Solution</h2>
